package edu.curtin.terminalgriddemo.eventparser;/* Generated By:JavaCC: Do not edit this line. MyParser.java */
import java.util.*;
...
public class MyParser implements MyParserConstants {
  ...
  static final public Map<String, String> Event() throws ParseException {
   String date = null;
   String time = null;
